...
//        startActivity(intent);
    ...
    public void whatsappCommunity(View view) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://whatsapp.com/channel/0029VacBQscK5cD8lvgWML26"));
        startActivity(intent);
    }
    ...
    public void shareWithFriends(View view) {
        ...
        String string = "Try this ChatGpt MyAI chatbot with amazing features" +
                "" +
                "\n\nhttps://github.com/manish7924/ChatGpt-MyAI/releases";
